...
class depOnboardingViewController: UIViewController, SwiftyOnboardDataSource {
    ...
    func setupPages() {
        ...
        page1.imageView.image = UIImage(named: "onboarding1")
        page2.imageView.image = UIImage(named: "onboarding2")
        page3.imageView.image = UIImage(named: "onboarding3")
        ...
        page1.subTitle.font = UIFont(name: page1.subTitle.font.fontName, size: 16)
